...
export default function Home() {
  return (
    <div className="flex flex-col">
      <div className="flex flex-row fixed w-[100%] grid-cols-3 grid-rows-1 min-h-20 max-h-30 text-black bg-white ">
        ...
        <div className="col-3 m-auto max-w-20">
      ...
      <div className="flex w-full @container">
        <div className="grid w-full h-500 md:h-500 grid-cols-10 grid-rows-50 md:grid-rows-10 bg-[url(./img/car-wash-1.jpg)]" id="packages">
          ...
          <div className="flex col-start-2 col-end-10 row-3 md:col-start-3  md:col-end-5 md:row-3 justify-center content-center bg-white ">
            <h1 className="text-black text-3xl md:text-5xl content-center text-center">Basic</h1>
          </div>
          <div className="flex col-start-2 col-end-10 row-15 md:col-start-5  md:col-end-7  md:row-3 justify-center content-center bg-white ">
            <h1 className="text-black text-3xl md:text-5xl content-center text-center">Premium</h1>
          </div>
          <div className="grid col-start-2 col-end-10 row-33 md:col-start-7 md:col-end-9 md:row-3 justify-center content-center bg-white ">
            <h1 className="text-black text-3xl md:text-5xl content-center text-center">Deluxe</h1>
          </div>
          ...
          <div className="flex col-start-2 col-end-10 row-4 row-span-9 md:col-start-3  md:col-end-5 md:row-start-4 md:row-span-5 bg-linear-10 from-white to-gray-900">
            <div className="grid grid-cols-1 grid-rows-17 p-5 w-1/1 text-1xl md:text-2xl text-white content-center justify-center">
              ...
              <div className="row-4 m-auto"><p>Interior Plastic Shine</p></div>
              <div className="row-5 m-auto"><p>Interior Aroma</p></div>
            </div>
          </div>
          ...
          <div className="flex col-start-2 col-end-10 row-16 row-span-15 md:col-start-5 md:col-end-7 md:row-start-4 md:row-span-5  bg-linear-10 from-orange-500 to-cyan-500">
            <div className="grid grid-cols-1 grid-rows-17 p-5 w-1/1 text-1xl md:text-2xl text-white content-center justify-center">
              ...
              <div className="row-7 m-auto"><p>Seat Cleaning</p></div>
              <div className="row-8 m-auto"><p>Detailed Panel Gaps Cleaning</p></div>
              <div className="row-9 m-auto"><p>Interior Aroma</p></div>
            </div>
          </div>
      ...
      <div className="grid w-full min-h-50 max-h-300 grid-cols-10 grid-rows-9 text-white bg-[url(./img/porsche.jpg)] bg-center bg-cover" id="contact">
        <div className="col-start-1 col-end-11 md:col-start-3 md:col-end-9 row-start-2 row-span-7 backdrop-blur-sm"></div>
        ...
        <div className="col-start-2 col-end-10 row-4 content-center justify-center z-1"><p className="text-md md:text-3xl text-center">☎️<a href="tel:+16263912351">(626) 391-2351</a></p></div>
        <div className="col-start-2 col-end-10 row-5 content-center justify-center z-1"><p className="text-md md:text-3xl text-center">📧 <a href="mailto:freshflowautospa@gmail.com">freshflowautospa@gmail.com</a></p></div>
        <div className="col-start-2 col-end-10 row-6 content-center justify-center z-1"><p className="text-md md:text-3xl text-center">📍Service Areas: Mira Loma, Corona, Chino, Riverside, San Bernardino</p></div>
